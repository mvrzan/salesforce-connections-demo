...
const SuperFastInternet = () => {
  return (
    <section className="w-full pt-16 pb-24 text-center relative overflow-hidden">
      <img
        src={greenOrbs}
        alt="Green Orbs Background"
        className="absolute left-0 top-0 md:top-8 w-64 md:w-80 lg:w-[400px] h-auto z-0"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-center gap-12 w-full px-4">
