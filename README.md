...
6. Various web events get captured based on the [pre-defined web event JSON schema](./salesforce_config/data_cloud_web_connector/quadstar_web_schema.json) and custom react [useSalesforceInteractions.ts](./client/src/hooks/useSalesforceInteractions.ts) hook
